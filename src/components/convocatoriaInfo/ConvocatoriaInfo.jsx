    ...
    return (
      <div>
        ...
        <div className='convocatoria-container'>
          <p>A los equipos representativos de las Delegaciones Sindicales de los Institutos Tecnológicos y Centros de: Mazatlán, Culiacán, Los Mochis, Huatabampo, Guaymas, Hermosillo, Valle del Yaqui, Nogales, Agua Prieta, Mexicali, Tijuana, Ensenada y La Paz B.C. a participar en el <b><i>“X Evento Nacional Cultural y Deportivo de la Sección 61 del SNTE Zona Norte Pacífico”</i></b>.</p>
          ...
          <div className="bases">
            <div className='card-item'>
              <p>
                <b>01.</b>
                <br></br>
                El torneo tiene como propósito principal fomentar la competencia deportiva entre las delegaciones sindicales y los miembros que las componen, en un marco de unidad, respeto y convivencia fraternal.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>02.</b>
                <br></br>
                El torneo tendrá como sede el Instituto Tecnológico de Ensenada, Baja California, durante los días 23 de junio al 28 de junio de 2024.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>03.</b>
                <br></br>
                Los participantes serán: todas las Delegaciones Sindicales de la Zona Norte Pacífico que tengan una representación deportiva en las disciplinas convocadas.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p> 
                <b>04.</b>
                <br></br>
                Cada equipo podrá registrar un máximo de jugadores de acuerdo a los reglamentos de la disciplina correspondiente. Todos los jugadores deberán de presentarse a los partidos debidamente uniformados.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>06.</b>
                <br></br>
                La inscripción deberá realizarse antes del 15 de Junio enviando la siguiente documentación al correo: <a href= "mailto: ensenada_pre2024@ite.edu.mx"> ensenada_pre2024@ite.edu.mx </a>
              </p>
              ...
              <li>Por acuerdo de los Secretarios Generales Delegacionales se determinó que la
                  ...
                  cada disciplina que deberá ser entregada a la Sede el día del registro.
              </li>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>07.</b>
                <br></br>
                Se confirmará la inscripción mediante la entrega formal de la documentación que acrediten a los jugadores, el día 23 de junio de 2024 de 14:00 a 16:00 horas en el Centro de información planta baja del I.T. de Ensenada, Baja California.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>08.</b>
                <br></br>
                Los jugadores serán acreditados mediante:
              </p>
            ...
            <div className='card-item'>
              <p>
                <b>09.</b>
                <br></br>
                El sistema de competencia será de acuerdo al Reglamento Deportivo de la Sección 61.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>10.</b>
                <br></br>
                La junta previa se llevará a cabo el día 23 de junio de 2024 a las 16:00 horas en el
            ...
            <div className='card-item'>
              <p>
                <b>11.</b>
                <br></br>
                Los equipos deberán estar presentes en la ceremonia de inauguración debidamente uniformados.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>12.</b>
                <br></br>
                Se aplicará el Reglamento establecido por la Federación Mexicana de la disciplina
            ...
            <div className='card-item'>
              <p>
                <b>13.</b>
                <br></br>
                La Ceremonia de Inauguración dará inicio a las 09:00 horas del día 24 de Junio de
            ...
            <div className='card-item'>
              <p>
                <b>14.</b>
                <br></br>
                Se entregará trofeo/medalla constancia a los tres primeros lugares de cada disciplina
                deportiva.
              </p>
            </div>
            ...
            <div className='card-item'>
              <p>
                <b>15.</b>
                <br></br>
                Los gastos derivados por el traslado y la estancia de los equipos para su participación
            ...
            <div className='card-item'>
              <p>
                <b>16.</b>
                <br></br>
                Todo el desarrollo del torneo y las actividades colaterales, serán coordinadas por el
            ...
            <div className='card-item'>
              <p>
                <b>17.</b>
                <br></br>
                El Comité Organizador aplicará los términos del Reglamento de los Torneos
            ...
            <div className='card-item'>
              <p>
                <b>18.</b>
                <br></br>
                Las protestas se harán inmediatamente después del partido celebrado y tendrán que
            ...
            <div className='card-item'>
              <p>
                <b>19.</b>
                <br></br>
                La Secretaria General de la Delegación D-V-04, el Secretario de Cultura y Deporte
                ...
                se constituye para dirimir las protestas de los equipos participantes en los torneos.
              </p>
            </div>
